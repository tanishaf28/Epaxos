#!/bin/bash
# ================================================================
# HETERO-5 NETEM SINGLE DELAY RUN + TIMELINE (EPaxos): one steady-state
...
#
# Adapted from run_hetero5_ratio_delay_5c_b100.sh's trailing timeline
# case, standalone.
# ================================================================
...
echo "================================================================"
echo " HETERO-5 NETEM CYCLE RUN (EPaxos): ${NORMAL_SECONDS}s normal / ${DELAY_MS}ms+-${JITTER_MS}ms for ${BURST_SECONDS}s, x${NUM_CYCLES}, indep=100, batch=10"
echo "================================================================"
...
echo ""
echo "=================================================="
echo " Hetero-5 netem single delay run complete (EPaxos)"
echo "=================================================="
