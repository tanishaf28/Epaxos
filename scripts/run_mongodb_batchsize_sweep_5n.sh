#!/bin/bash
# ================================================================
# MongoDB EVAL 2 (EPaxos port): Batch Size Sweep,
...
# 1,10,50,100,500,1000,2000, indep=90, msgsize=512), but against the
...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║ MONGODB BATCH SIZE SWEEP, HETEROGENEOUS 5-NODE (2s+3w) EPaxos  ║"
echo "╚════════════════════════════════════════════════════════════════╝"
...
for batch_size in "${TEST_CASES[@]}"; do
    run_case "n5_mongo_batch_${batch_size}" "$batch_size"
done
...
echo ""
echo "=================================================="
echo " MongoDB batch size sweep complete"
echo "=================================================="
