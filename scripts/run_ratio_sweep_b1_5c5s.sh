#!/bin/bash
# ================================================================
# HETERO-5 RATIO SWEEP (EPaxos): NUM_SERVERS=5, NUM_CLIENTS=5,
...
# scripts. No netem delay, no crash injection -- plain steady-state
# per case, mirrors run_plain_b1_r90_5c5s.sh but looped over ratio.
# ================================================================
...
echo "================================================================"
echo " HETERO-5 RATIO SWEEP (EPaxos): batch=1, maxinflight=5, 5s/5c"
echo "================================================================"
...
echo ""
echo "=================================================="
echo " Hetero-5 ratio sweep complete (EPaxos)"
echo "=================================================="
