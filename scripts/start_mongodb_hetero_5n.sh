...
CONFIG_PATH="${REMOTE_DIR}/config/cluster_hetero_mongo_5n.conf"
...
echo "  - 2 Strong nodes (c32): 192.168.73.59, 192.168.73.243"
echo "  - 3 Weak nodes (c8):   192.168.73.117, 192.168.73.16, 192.168.73.94"
