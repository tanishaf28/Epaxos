#!/bin/bash
# ================================================================
# MongoDB Cluster Stopper - HETEROGENEOUS, SELECTABLE SIZE (EPaxos)
...
case "$NUM_SERVERS" in
    ...
    5)  DEFAULT_CONFIG="cluster_hetero_mongo_5n.conf" ;;
...
echo "=================================================="
echo " EPaxos MongoDB ${NUM_SERVERS}-NODE Cluster Shutdown"
